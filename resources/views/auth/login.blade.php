...
<head>
    ...
    <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
        ...
        crossorigin=""></script>
    <script src="{{asset('app-assets/auth/main.js')}}"></script>
    <title>Login</title>
</head>
...
<body onload="init()">
    ...
    <div class="login-div">
        ...
        <div class="sub-title">votre plateforme digital mapping</div>
        <form class="fields"  action="{{ route('login') }}" method="POST">
            @csrf
            <div class="username">
